...
/** Token Manager. */
@SuppressWarnings("unused")public class DCParserTokenManager implements DCParserConstants {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 0:
                  ...
                  else if ((0x40800000000000L & l) != 0L)
                  {
                     if (kind > 9)
                        kind = 9;
                  }
                  else if ((0x200000040000000L & l) != 0L)
                  {
                     if (kind > 8)
                        kind = 8;
                  }
...
"", null, null, null, null, null, "\55", "\73", null, null, null, null, null, 
"\50", "\51", "\173", "\175", };
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public DCParserTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public DCParserTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
